...
def train(args=get_args()):
    ...
    save_dir=os.path.join(args.save_dir,args.task,'IQL', 'GroundTruth', 'seed{}'.format(args.seed),timestamp)
    ...
    output_config = {
        ...
        "tb": "tensorboard",
        "wandb": {'project':'IQL_{}'.format(args.task),'group':'{}'.format('GroundTruth'),'name':'seed{}_{}'.format(args.seed,timestamp),'job_type':'', 'cfg':{'task':args.task,'seed':args.seed,'save_dir':save_dir}, 'wandb_dir':save_dir}
    }
