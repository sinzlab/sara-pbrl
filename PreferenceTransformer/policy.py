...
class NormalTanhPolicy(nn.Module):
    ...
    # def __init__(self):
    #     super().__init__()
    # def __init__(self, hidden_dims: Sequence[int], action_dim: int, state_dependent_std: bool = True, dropout_rate: Optional[float] = None, log_std_scale: float = 1.0, log_std_min: Optional[float] = None, log_std_max: Optional[float] = None, tanh_squash_distribution: bool = True):
